...
export default function Home() {
  ...
  if (carregando) {
    return (
      <div className="min-h-[100svh] relative flex flex-col items-center justify-center overflow-hidden bg-dark text-light px-6">
        <div className="absolute inset-0 bg-gradient-to-br from-dark via-dark to-primary/20 opacity-60" />
  ...
  return (
    <div className="min-h-[100svh] relative flex flex-col items-center justify-center overflow-hidden bg-dark text-light px-6 py-12">
      <div className="absolute inset-0 bg-gradient-to-br from-dark via-dark to-primary/25 opacity-80" />
      ...
      <div className="relative z-10 w-full max-w-sm flex flex-col items-center text-center">
        ...
        <div className="mt-8 animate-fade-up animate-delay-100">
          <p className="text-sm font-medium uppercase tracking-[0.2em] text-primary/90 mb-2">
            Bem-vindo ao
          </p>
        ...
        <div className="mt-10 w-full animate-fade-up animate-delay-200">
          <button
            ...
            className="group w-full py-4 bg-light text-dark font-bold rounded-2xl shadow-[0_10px_40px_-12px_rgba(255,255,255,0.3)] transition-all duration-300 hover:shadow-[0_14px_48px_-10px_rgba(255,255,255,0.4)] active:scale-[0.97] flex items-center justify-center gap-2"
          >
            Ver Cardápio
            <ChevronRight
              size={20}
